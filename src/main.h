...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.5 * COIN;	// 50% monthly interest
...
static const uint256 hashGenesisBlock("0x000002ffa00294db82186dc0cd54126efa91d846457b0c2c7541e9db330bad0f");
static const uint256 hashGenesisBlockTestNet("0x000002ffa00294db82186dc0cd54126efa91d846457b0c2c7541e9db330bad0f");
...
public:
    ...
    {
        // GHScoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // GHScoin: get transaction coin age
...
public:
    ...
    // GHScoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // GHScoin: two types of block: proof-of-work or proof-of-stake
    ...
    // GHScoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // GHScoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // GHScoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // GHScoin: block index flags
    enum  
    {
